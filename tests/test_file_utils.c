...
static char* test_file_get_lines () {
	file_get_lines("test_data/example.conf", &tfu__callback);
...
static char* test_multi_chunk_file () {
	...
	file_get_lines("test_data/multi_chunk_file", &tfu__multi_callback);
...
static char* test_file_get_contents () {
	char* contents = file_get_contents("test_data/multi_chunk_file");
